...
switch ($_GET["op"]) {
    ...
    case 'todos': //TODO: Procedimeinto para cargar todos las datos de los proveedores
        ...
        $datos = $miembros ->todos(); // Llamo al metodo todos de la clase proveedores.model.php
    ...
    case 'insertar':
        ...
        $datos = array();
        $datos = $miembros ->insertar($nombre, $apellido, $email, $telefono, $Clubes_club_id);
    ...
    case 'actualizar':
        ...
        $Clubes_club_id = $_POST["Clubes_club_id"];
        $datos = array();
        $datos = $miembros ->actualizar($miembro_id, $nombre, $apellido, $email, $telefono, $Clubes_club_id);
        echo json_encode($datos);
        break;
